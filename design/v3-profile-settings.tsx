/**
 * from Paper — v3 Profile Settings
 * Artboard ID: 5TP-0
 */
export default function V3ProfileSettings() {
  return (
        ...
        <div className="flex flex-col grow shrink basis-[0%] py-8 px-12 overflow-clip gap-8">
          ...
          <div className="flex flex-col pb-8 gap-5 border-b border-b-solid border-b-[#2E2E2C0F]">
            ...
            <div className="flex items-center gap-5">
              <div className="opacity-[0.8] shrink-0 rounded-[100px] bg-[#9C9B90] size-16" />
              <div className="flex flex-col gap-1">
                ...
                <div className="inline-block [white-space-collapse:preserve] text-wrap text-[#2E2E2C] font-['SpaceGrotesk-Medium','Space_Grotesk',system-ui,sans-serif] font-medium text-xs/3.5">
                  Change photo
                </div>
              </div>
            </div>
            <div className="flex gap-6">
              ...
              <div className="flex flex-col grow shrink basis-[0%] gap-1.5">
                ...
                <div className="flex items-center justify-between h-11 opacity-[0.6] rounded-[10px] px-3.5 bg-white border border-solid border-[#2E2E2C14] shrink-0">
                  <div className="inline-block text-[#2E2E2C] font-['SpaceGrotesk-Regular','Space_Grotesk',system-ui,sans-serif] text-sm/4.5">
                    marcus@acme.com
                  </div>
                  <div className="inline-block [white-space-collapse:preserve] text-wrap text-[#2E2E2C] font-['SpaceGrotesk-Medium','Space_Grotesk',system-ui,sans-serif] font-medium text-xs/3.5">
                    Change
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between py-1">
              ...
              <div className="w-9 h-5 flex items-center justify-end shrink-0 rounded-[100px] bg-[#2E2E2C] p-0.5">
            ...
            <div className="flex items-center justify-between py-1">
              <div className="flex flex-col gap-0.5">
                ...
                <div className="inline-block text-[#A3A39E] font-['SpaceGrotesk-Regular','Space_Grotesk',system-ui,sans-serif] text-xs/4">
                  Show notifications in your inbox
                </div>
              </div>
              <div className="w-9 h-5 flex items-center justify-end shrink-0 rounded-[100px] bg-[#2E2E2C] p-0.5">
                <div className="rounded-[100px] bg-white shrink-0 size-4" />
            ...
            <div className="flex items-center justify-between py-1">
              ...
              <div className="w-9 h-5 flex items-center justify-start shrink-0 rounded-[100px] bg-[#2E2E2C18] p-0.5">
                <div className="rounded-[100px] bg-white shrink-0 size-4" />
              </div>
            </div>
          </div>
